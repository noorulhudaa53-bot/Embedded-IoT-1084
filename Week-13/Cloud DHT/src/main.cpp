...
#define BLYNK_TEMPLATE_ID "TMPL6i9_Nd6Vm"
#define BLYNK_TEMPLATE_NAME "DHT 1084 Noor"
#define BLYNK_AUTH_TOKEN "AxgdRfFeCmilZBfxFq-CiW6OM1uwywbP"  // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
